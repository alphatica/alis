...
public class DonchianSingle {
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException, IOException {
        ...
        StrategyExecutor executor = new StrategyExecutor().withInitialCash(initialCash).withTimeRange(new Time(2018_02_01), new Time(2025_01_01));
        Account account = executor.execute(stooqData, new DonchianStrategy(47, 116, true, true));
