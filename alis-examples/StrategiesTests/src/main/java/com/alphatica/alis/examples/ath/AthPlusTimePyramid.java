...
public class AthPlusTimePyramid {
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        StrategyExecutor executor = new StrategyExecutor().withInitialCash(100_000).withTimeRange(new Time(2004_01_01), new Time(2025_01_01)).withTradePrice(TradePrice.AVERAGE).withCommission(0.003).withLimitOrderSize(0.2);
