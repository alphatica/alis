...
public class ChangeCheckExecutor {
	...
	public static ChangeCheckResult execute(ChangeCheck changeCheck, MarketData marketData) throws ExecutionException, InterruptedException {
		...
		GreenLambdaExecutor<List<SingleMatchResult>> executor = new GreenLambdaExecutor<>();
	...
	private static TreeMap<Time, List<SingleMatchResult>> collectResults(GreenLambdaExecutor<List<SingleMatchResult>> executor) throws ExecutionException, InterruptedException {
	...
	private static void submitChecks(ChangeCheck changeCheck, MarketData marketData, int benchmarkStartTimeIndex, List<Time> times, List<Market> markets, GreenLambdaExecutor<List<SingleMatchResult>> executor) {
